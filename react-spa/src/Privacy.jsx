...
Jad Joubran B.V. ("us", "we", or "our") operates the https://react-tutorial.app website (the "Service").

This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy for Jad Joubran B.V. is based on the Free Privacy Policy Template Website.
...
Security Cookies. We use Security Cookies for security purposes (Cloudflare, Stripe).
Use of Data
Jad Joubran B.V. uses the collected data for various purposes:
...
Jad Joubran B.V. will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.

Disclosure Of Data
Legal Requirements
Jad Joubran B.V. may disclose your Personal Data in the good faith belief that such action is necessary to:

To comply with a legal obligation
To protect and defend the rights or property of Jad Joubran B.V.
